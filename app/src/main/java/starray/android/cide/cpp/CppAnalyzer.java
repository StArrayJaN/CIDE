...
import static io.github.rosemoe.sora.widget.schemes.EditorColorScheme.OPERATOR;
import static io.github.rosemoe.sora.widget.schemes.EditorColorScheme.TEXT_NORMAL;
import static starray.android.cide.cpp.NewScheme.TYPE_NAME;
import static starray.android.cide.cpp.NewScheme.forComment;
import static starray.android.cide.cpp.NewScheme.forKeyword;
import static starray.android.cide.cpp.NewScheme.forString;
...
public class CppAnalyzer extends BaseIncrementalAnalyzeManager {
  ...
  protected int[][] getMultilineTokenStartEndTypes() {
    final int start[] = new int[]{CPP14Lexer.Div, CPP14Lexer.Star};
    final int end[] = new int[]{CPP14Lexer.Star, CPP14Lexer.Div};
